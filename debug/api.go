...
func main() {
	...
	r.POST("/offboard", func(c *gin.Context) {
		...
		fmt.Println("Ontvangen Voornaam:", Voornaam)
    		fmt.Println("Ontvangen Achternaam:", Achternaam)
		
		if Voornaam == "" || Achternaam == "" {
        	fmt.Println("Waarschuwing: Geen gegevens ontvangen voor Voornaam of Achternaam!")
    		}
